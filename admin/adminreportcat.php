...
<table width="1024" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<?php if (isset($_SESSION["USERNAME"])) { ?>
      <a href="adminreportmonthly.php"><img src="image/btnreportmon.png"
					alt="Monthly Report" width="200" height="35" border="0" /> </a><a
				href="adminreportcat.php"><img src="image/btnreportbook.png"
					alt="Add New Book" width="200" height="35" border="0" /> </a><br />
    <iframe src="adminreportcatreport.php" width="450" height="400" frameborder="0"></iframe>
  <?php } else {
