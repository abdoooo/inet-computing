...
<table width="1024" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <?php if (isset($_SESSION["USERNAME"])) { ?>
	 <form id="form3" name="form3" method="post" action="php/adminadd.php">
            <table width="80%" border="0">
              <tr>
                <td width="40%" align="left" valign="top" bgcolor="#999999">Username:</td>
                <td width="60%" align="left" valign="top" bgcolor="#999999"><input type="text" name="txtusername" id="txtusername" /></td>
              </tr>
              <tr>
                <td align="left" valign="top" bgcolor="#999999">Password:</td>
                <td align="left" valign="top" bgcolor="#999999"><input type="text" name="txtpass" id="txtpass" /></td>
              </tr>
              <tr>
                <td align="left" valign="top" bgcolor="#999999">Confirm Password:</td>
                <td align="left" valign="top" bgcolor="#999999"><input type="text" name="txtconfirmpass" id="txtconfirmpass" /></td>
              </tr>
            </table>
            <p>
              <label>
