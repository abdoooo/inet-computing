				...
				<form id="form1" name="form1" method="post" action="">
					...
					<table width="800" border="0" cellspacing="2" cellpadding="2">
						<tr>
							...
							<td align="center" bgcolor="#cccccc">BOOK</td>
							<td width="100" align="center" bgcolor="#cccccc">AUTHOR</td>
							<td width="100" align="center" bgcolor="#cccccc">CATEGORY</td>
							<!--<td align="center" bgcolor="#cccccc">DESCRIPTION</td>-->
							<td width="100" align="center" bgcolor="#cccccc">PRICE</td>
							<td width="100" align="center" bgcolor="#cccccc">DISCOUNT</td>
							<!--<td align="center" bgcolor="#cccccc">Publication Date</td>-->
							<td width="100" align="center" bgcolor="#cccccc">AVAILABLE</td>
						</tr>
						...
						*/
						...
						<tr>
							...
							<td align="center" bgcolor="#cccccc"><a
								href="book_modify.php?isbn=<?php echo $result['ISBN'] ?>">
									<img src="../bookimage/<?php echo $result['IMG']?>"
									width="200" height="200" border="0" /> <br /> <?php echo $result['TITLE']  ?>
									<br /> ISBN: <?php echo $result['ISBN']  ?>
							</a>
							</td>
							<td width="100" align="center" bgcolor="#cccccc"><?php echo $result['AUTHOR'] ?>
							</td>
							<td width="100" align="center" bgcolor="#cccccc"><?php echo $result['CAT_ID']; ?>
							</td>
							<!-- <td align="center" bgcolor="#cccccc"><?php //echo $result['DESCR'] ?></td>-->
							<td width="100" align="center" bgcolor="#cccccc"><?php echo $result['PRICE'] ?>
							</td>
							<td width="100" align="center" bgcolor="#cccccc"><?php echo $result['DIST'] ?>
							</td>
							<!--<td align="center" bgcolor="#cccccc"><?php //echo $result['PUBDATE'] ?></td>-->
							<td width="100" align="center" bgcolor="#cccccc"><?php echo $result['AVAB'] ?>
							</td>
						</tr>
