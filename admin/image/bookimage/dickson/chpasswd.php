	...
	<div class="tail-middle">
			<div class="row-2">
				<div class="inside">
					...
					<tr>
					<td>New Password: </td><td><input type="text" name="newpassword" id="newpassword"/></td>
					</tr>
					<tr>
					<td>Re-confimr New Password: </td><td><input type="text" name="newcpassword" id="newcpassword"/></td>
					</tr>
					<tr>
