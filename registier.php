	...
	//**********************************//
				...
				<form id="cust_reg" method="POST" action="cust_progress.php?progressID=cust_reg">
					...
					<?  require_once('recaptchalib.php');
					  $publickey = "6LerFcoSAAAAACgvHmaacR2CwF-Go1d2ypbNU0rb"; // you got this from the signup page
					...
					<td colspan="2" align="center">
					<?php
					if ( htmlspecialchars($_GET["error"]) == "captcha"){
						echo "<font color=red>Security Code entered incorrect, please try again</font>";
					}
					?>	
					</td>
					</tr>
