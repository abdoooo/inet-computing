...
<!-- header -->
	<div id="header">
		<div class="row-1">
			...
			<div id="search" style = "padding: 20px 50px 0 0">
             <table>
...
<div id="slideshow">
	...
	<div id="foobar">
		...
		<div id="col2">
			<div class="viewer">
				<div class="reel">
					<div class="slide"><img src="images/avd1.bmp" width="568" height="243" alt="" /></div>
					<div class="slide"><img src="images/avd2.bmp" width="568" height="243" alt="" /> </div>
					<div class="slide"><img src="images/avd3.bmp" width="568" height="243" alt="" /> </div>
				</div>
			</div>
		</div>
