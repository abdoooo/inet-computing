...
define("EW_RANDOM_KEY", 'TXO0cp0UYGNxWRI9', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "project2.css", TRUE); // Project stylesheet file name
