    ...
    <div class="span11">
        ...
        <form id="startsearch" name="startsearch" action="index.php?search=1" method="post" class="navbar-search pull-right" onsubmit="return checkData();">
            <div class="input-append">
                <input class="span2" id="search_data" name="search_data" type="text" data-provide="typeahead" placeholder="Search" data-source='[<?php include ('searchdata.txt'); ?>]'><button type="submit" class="btn">Search</button>
            </div>
        </form>
